	...
	return (
		<div className="min-h-screen bg-canvas-default text-fg-default font-inter selection:bg-orange-500/30 overflow-hidden">
			...
			<main className="pb-16 sm:pb-24">
				...
				<section
					id="about"
					className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 border-t border-[#F2F2F2]/10 scroll-mt-20 sm:scroll-mt-24"
				>
					<div className="flex flex-col md:flex-row gap-8 md:gap-12">
						<div className="md:w-1/4">
							<TextReveal>
								<div className="sticky top-24 space-y-4">
									<h2 className="text-lg sm:text-xl font-mono font-bold text-[#F2F2F2] uppercase tracking-[0.25em] leading-tight">
										Protocol
										<br />
						...
						{/* Cabinet Frame 01 */}
						<div className="md:w-3/4 bg-[#1e1e1e] p-3.5 sm:p-6 rounded-3xl border-4 border-[#262626] shadow-[inset_0_4px_20px_rgba(0,0,0,0.8),0_12px_40px_rgba(0,0,0,0.5)] relative space-y-6">
								...
								{[
									...
									<ScrollReveal key={card.tag} baseOpacity={0} baseRotation={0} enableBlur={false} className="h-full">
										<div className="group h-full flex flex-col">
											...
											<div className="bg-[#262626] p-5 sm:p-6 rounded-b-xl rounded-tr-xl border-2 border-[#F2F2F2]/10 group-hover:border-[#56BF99]/50 active:border-[#56BF99]/50 transition-all shadow-md flex-1 flex flex-col justify-start space-y-3">
												<div className="text-[10px] sm:text-[11px] font-mono uppercase tracking-[0.25em] flex items-center gap-2 font-bold shrink-0" style={{ color: card.accent }}>
				...
				<section
					id="skills"
					className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24 border-t border-[#F2F2F2]/10 scroll-mt-20 sm:scroll-mt-24"
				>
					<div className="flex flex-col md:flex-row gap-8 md:gap-12">
						<div className="md:w-1/4">
							<TextReveal>
						...
						<div className="md:w-3/4 bg-[#1e1e1e] p-3.5 sm:p-6 rounded-3xl border-4 border-[#262626] shadow-[inset_0_4px_20px_rgba(0,0,0,0.8),0_12px_40px_rgba(0,0,0,0.5)] relative space-y-6">
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
								...
								<div className="group">
									...
									<div className="bg-[#262626] p-5 sm:p-6 rounded-b-2xl rounded-tr-2xl border-2 border-[#F2F2F2]/12 group-hover:border-[#56BF99]/60 active:border-[#56BF99]/60 transition-all shadow-xl space-y-4">
										...
										<div className="flex flex-wrap gap-2">
											{[
												...
												<span
													key={s}
													className="px-2.5 sm:px-3 py-1.5 text-[10px] sm:text-[11px] font-mono font-bold uppercase tracking-wider bg-[#F2F2F2]/5 border border-[#F2F2F2]/15 rounded-lg text-[#F2F2F2]/80 hover:text-[#56BF99] hover:border-[#56BF99]/50 transition-colors"
												>
													{s}
												</span>
											))}
									...
									<div className="bg-[#262626] p-5 sm:p-6 rounded-b-2xl rounded-tr-2xl border-2 border-[#F2F2F2]/12 group-hover:border-[#56BF99]/60 active:border-[#56BF99]/60 transition-all shadow-xl space-y-4">
										...
										<div className="flex flex-wrap gap-2">
											{[
												...
												<span
													key={s}
													className="px-2.5 sm:px-3 py-1.5 text-[10px] sm:text-[11px] font-mono font-bold uppercase tracking-wider bg-[#F2F2F2]/5 border border-[#F2F2F2]/15 rounded-lg text-[#F2F2F2]/80 hover:text-[#EBCA5E] hover:border-[#EBCA5E]/50 transition-colors"
												>
													{s}
												</span>
											))}
						...
						<div className="md:w-3/4 bg-[#1e1e1e] p-3.5 sm:p-6 rounded-3xl border-4 border-[#262626] shadow-[inset_0_4px_20px_rgba(0,0,0,0.8),0_12px_40px_rgba(0,0,0,0.5)] relative space-y-6">
							...
							{[
								...
								<div key={job.company} className="relative group">
									...
									<div className="flex items-center">
										<div className="bg-[#262626] border-t-2 border-l-2 border-r-2 border-[#F2F2F2]/15 rounded-t-xl px-3 sm:px-4 py-1 font-mono text-[9px] sm:text-[10px] font-bold text-[#F2F2F2]/70 group-hover:text-[#56BF99] group-hover:border-[#56BF99]/50 transition-all flex items-center gap-2 sm:gap-3">
											<span className="w-1.5 h-1.5 rounded-full bg-[#56BF99]" />
									...
									<div className="bg-[#262626] p-5 sm:p-8 rounded-b-2xl rounded-tr-2xl border-2 border-[#F2F2F2]/12 group-hover:border-[#56BF99]/60 active:border-[#56BF99]/60 transition-all shadow-xl relative overflow-hidden">
										<div className="flex flex-col sm:flex-row justify-between sm:items-center mb-3 sm:mb-4 gap-2">
											<h3 className="text-xl sm:text-2xl font-mono font-bold text-[#F2F2F2] tracking-tight">
												{job.company}
											</h3>
											<span className="text-[9px] sm:text-[10px] font-mono font-bold text-[#EBCA5E] bg-[#EBCA5E]/10 px-3 py-1 rounded-full border border-[#EBCA5E]/20 tracking-[0.15em] self-start sm:self-auto">
												{job.period}
											</span>
										</div>

										<p className="text-[#56BF99] text-[11px] sm:text-xs font-mono font-bold uppercase tracking-[0.2em] sm:tracking-[0.25em] mb-4 sm:mb-6 flex items-center gap-2">
											<span className="w-1.5 h-1.5 bg-[#56BF99] rounded-full" />
											{job.role}
										</p>

										<ul className="space-y-2.5 sm:space-y-3 border-t border-[#F2F2F2]/5 pt-4">
											{job.tasks.map((task) => (
												<li
													key={task}
													className="text-xs sm:text-sm text-[#F2F2F2]/80 flex items-start gap-3 sm:gap-4 font-sans leading-relaxed"
												>
													<span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#D96459] shrink-0" />
													{task}
												</li>
											))}
										</ul>
				...
				<section
					...
					className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24 border-t border-[#F2F2F2]/10 scroll-mt-20 sm:scroll-mt-24"
				>
					<div className="bg-[#262626] p-6 sm:p-16 rounded-3xl text-center border-2 border-[#F2F2F2]/15 shadow-2xl relative overflow-hidden">
						...
						<h2 className="text-2xl sm:text-5xl font-mono font-bold text-[#F2F2F2] mb-4 sm:mb-6 tracking-tight uppercase leading-tight max-w-2xl mx-auto">
							INITIATE DIGITAL <br />{' '}
							<span className="text-[#56BF99]">
								COLLABORATION
							</span>
						</h2>
						<p className="text-xs sm:text-base text-[#F2F2F2]/70 max-w-xl mx-auto mb-8 sm:mb-10 font-sans leading-relaxed">
						...
						<a
							...
							className="bg-[#56BF99] text-[#262626] border-2 border-[#262626] px-8 sm:px-10 py-3.5 sm:py-4 rounded-full font-mono font-bold transition-all hover:bg-[#F2F2F2] active:scale-95 shadow-xl uppercase tracking-[0.15em] sm:tracking-[0.2em] text-xs inline-block"
						>
							Synchronize Now
						</a>
					</div>
			...
			<footer className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 border-t border-[#F2F2F2]/10 text-center text-xs font-mono text-[#F2F2F2]/50">
				<p>
